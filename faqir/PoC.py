    ...
    def makeTest(self,direcao):
        ...
        if clientOrServer == 1:
            ...
            if self.serverReady:
                ...
                cmd = "socat tcp-listen:"+str(self.iperf_port)+",reuseaddr,fork udp:" + ipPeer + ":" + str(self.server_tcp_hole)+",sp="+str(self.tcp_local_port)
                cmd2 = "socat udp-listen:"+str(self.iperf_port)+",reuseaddr,fork udp:" + ipPeer + ":" + str(self.server_udp_hole)+",sp="+str(self.udp_local_port)
            ...
            if self.gonnaTest:
                ...
                cmd = "socat udp-listen:"+str(self.tcp_local_port)+",reuseaddr,fork tcp:localhost:"+str(self.udp_local_port)
                print(cmd)
